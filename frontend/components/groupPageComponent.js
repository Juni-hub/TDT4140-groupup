...
import {CardBody,CardImg, CardHeader, Row, Col, Card, List, CardText,ListInlineItem,Badge, Spinner, CardGroup, CardTitle, Button } from "reactstrap";
    ...
    return(
        ...
        <>
            ...
            <Card style={{backgroundColor:"lightgreen"}}>
                <CardBody>
                    <Row style={{margin:"10px", marginBottom:"40px" ,height:"70px"}}><CardTitle style={{fontSize:"60px"}}>{group.name}</CardTitle></Row>
                    <CardGroup>
                        ...
                        <Card style={{margin:"20px",backgroundColor:"#fff"}}>
                            <CardBody>
                                ...
                                <br/>
                                <br/>
                                <CardTitle tag="h5" style={{fontSize:"25px"}}> Medlemmer:</CardTitle>
                                <hr />
                                <List type="inline">
                        ...
                        <Card style={{margin:"20px", marginTop:"50px",backgroundColor:"#fff"}}>
                            <CardBody>
                                <CardTitle tag="h5" style={{fontSize:"30px", textAlign:"center"}}>Beskrivelse</CardTitle>
                                <hr></hr>
                                <CardText style={{fontSize:"20px"}}>{group.description}</CardText>
                                <br />
                                <br />
                                <CardTitle tag="h5" style={{fontSize:"30px",textAlign:"center"}}>Interesser</CardTitle>
                                <hr />
                        ...
                        <Card style={{margin:"20px",marginTop:"50px",backgroundColor:"#fff"}}>
                            <CardBody>
                                <CardTitle tag="h5" style={{fontSize:"30px",textAlign:"center"}} >Matchede grupper</CardTitle>
                                <hr></hr>
                                <List style={{listStyle:"none"}}>
                                    <li><Button color="success" outline  size="lg" style={{margin:"10px"}}> Vi som liker øl</Button></li>
                                    <li><Button color="success" outline  size="lg" style={{margin:"10px"}}> Guttebanden</Button></li>
                                    <li><Button color="success" outline  size="lg" style={{margin:"10px"}}> Jentene</Button></li> 
                                </List>
                            </CardBody>
                        </Card>
                    </CardGroup>
